$(function(){
    ...
    // Avatar Upload
    document.querySelector('.main_body .profile .card #avatar_upload').addEventListener('change', readURL, true);
    function readURL(){
        var file = document.querySelector(".main_body .profile .card #avatar_upload").files[0];
